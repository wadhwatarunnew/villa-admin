...
<html lang="en">
   <head>
      <title>Villatent: Dashboard</title>
      <meta charset="utf-8">
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4">
                                       <div class="profileImage">
                                          <img src="images/profileimage.jpg" alt="image" title="profileImage">   
                                       </div>
                                       <div class="profileDesc">
                                          <h2><b>User Name:</b> <span>hjgjhgh</span></h2>
                                          <p><b>Last Logged in:</b> <span>5 hours ago</span></p>
                                          <div id="mybutton">
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="card mb-30">
							  ...
							  $("#end").keyup(function(){
								  //document.getElementById('d').innerHTML = "Match";
								  //alert("hh");
								  var v = $("#start").val()
