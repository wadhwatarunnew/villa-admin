...
if (isset($_POST['update'])){
	...
	if(!$imageUrl){
    	...
    	else
    	{
        	...
        	//header("location:edit-project-types.php?id=$id");
                     ...
                     <div class="row">
						...
						<?php include "alert-update.php";  ?>
                           <div class="card mb-30">
                              <div class="card-header">Seo Meta Tags &nbsp;<a href="project-listings.php" class="btn btn-sm btn-primary">Back</a></div>
                              <div class="card-body">
    ...
    <label for="id_radio2"><input id="id_radio2" type="radio" name="img" onclick="show4();"  checked="">Select New Image</label>
                                   ...
                                   <?php
									...
									if(!$b['local_path']){
										...
										?>
										<div class="col-sm-6" id="imgPreview1">
                                       <div class="commonSection"> 
                                          <label>Image</label>
                                            <img src="<?php echo $b['image']; ?>" class="img-thumbnail" >
                                       </div>
                                    </div>
