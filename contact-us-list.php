<?php 
   ...
   if(isset($_GET["id"]) && $_GET["id"] != '')
   {
      ...
      echo "<script>window.location.href='contact-us-list.php';</script>";
      exit;
   }
?>
                                    ...
                                    <?php
                                       ...
                                       while($b=mysqli_fetch_assoc($query4)) { ?>
                                          <tr role="row">
                                             ...
                                             <td>   
                                                <a href="contact-us-list.php?id=<?php echo $b['id']; ?>" onclick="return confirm('Are you sure you want to delete this?');">
