<?php 
   ...
   if(isset($_GET["id"]) && $_GET["id"] != '')
   {
      ...
      echo "<script>window.location.href='project-listings.php';</script>";
      exit;
   }
?>
            ...
            <div class="page-body">
      			<div class="listing-page-head">
      				...
      				<div class="listing-cta">
      					<a href="project-internals.php" class="btn btn-success btn-sm"><i class="feather icon-plus"></i> Add Project</a>
      				</div>
      			</div>
                                    ...
                                    <td>
                                       <div class="actions">
                                          <div class="table-actions">
                                             ...
                                             <a href="project-listings.php?id=<?php echo $b['id']; ?>" onclick="return confirm('Are you sure you want to delete this project?')">
