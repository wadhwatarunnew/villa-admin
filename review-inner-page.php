...
if (isset($_POST['sub'])){
	...
	{
    $FileExists = true;
    header( "refresh:2; url=review-inner-page.php" ); 
 }
 else
 {
    include "db.php";
    ...
    mysqli_query($con,"insert into home_testimonials (name,designation,rating,discription,image) values ('$fname','$desig','$rating','$editor1','$path') ");
    	...
    	//header("location:review-inner-page.php");
    header( "refresh:2; url=review-inner-page.php" ); 
 }
};
                           ...
                           <div class="row">
                              <div class="col-sm-4">
                                 <div class="commonSection">
                                    ...
                                    <input type="text" name="fname" class="form-control" placeholder="Author Name"/>
                                 </div>
                              </div>
                              <div class="col-sm-4">
                                 <div class="commonSection">
                                    <label>Author Designation</label>
                                    <input type="text" name="desig" class="form-control" placeholder="Author Designation"/>
                                 </div>
                              </div>
                              <div class="col-sm-4">
                                 <div class="commonSection">
                                    <label>Review Rating</label>
                                    <input type="text" name="rating" class="form-control" placeholder="Review Rating"/>
                                 </div>
                              </div>
                           </div>
                           <div class="row">
