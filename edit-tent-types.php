...
if (isset($_POST['update'])){
	...
	if(!$imageUrl){
		...
		else
		{
        	...
        	//header("location:edit-tent-types.php?id=$id");
				...
				<div class="page-body">
					...
					<form action ="" enctype="multipart/form-data" method="post">
										...
										<?php }else{  ?>
											...
											<div class="row">
												...
												<div class="col-sm-4">
													<div class="commonSection">
														<label>Meta Keyword</label>
														<textarea name="keyword1" id="metaTitle" class="form-control"  placeholder="Enter Keyword"><?php echo $b['keyword']; ?></textarea>
													</div>
												</div>
												<div class="col-sm-4">
													<div class="commonSection">
														<label>Meta Description</label>
														<textarea name="disc1" id="metaTitle" class="form-control"  placeholder="Enter Description"><?php echo $b['discription']; ?></textarea>
													</div>
												</div>
												<!--<input type="submit" class="btn btn-success btn-lg" name="update_seo" value="Save"> -->
											</div>
										...
										<div class="row">
												...
												<div class="col-sm-6">
													<div class="commonSection">
														...
														<select class="form-control" name="cat">
															...
															$queryll= mysqli_query($con,"select * from resort_category group by title");
															
															while($ll=mysqli_fetch_assoc($queryll)){
																?>
																
																<option value="<?php echo $ll['title']; ?>"><?php echo $ll['title']; ?></option>
											...
											<?php  }else {  ?>
												...
												<div class="col-sm-6">
													<div class="commonSection">
														<label>Order No.</label>
														<input class="form-control" type="number" name="order1" id="order" value="<?php echo $b['order_no']; ?>" placeholder="Page Order no">
													</div>
												</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="card mb-30">
									<div class="card-header">Manage Content Inner
										...
										<div class="row">
											...
											if(!$b['local_path']){
												...
												<div class="col-sm-8">
													<div class="commonSection">
														<label>Title</label>
														<input class="form-control" type="text" required name="title" id="title" value="<?php echo $b['title']; ?>" placeholder="Enter Heading">
													</div>
												</div>
												...
												<div class="col-sm-12">
													<div class="commonSection">
														...
														<input class="form-control" type="text" name="y_url" id="y_url" value="<?php echo $b['y_url']; ?>" placeholder="Enter Heading">
													</div>
												</div>
												...
												<div class="col-sm-12">
													<div class="commonSection">
														...
														<textarea name="editor2" id="editor2"  rows="10" cols="80" ><?php echo $b['dimension']; ?></textarea>
														<script>
															CKEDITOR.editorConfig = function (config) {
																config.language = 'es';
																config.uiColor = '#F7B42C';
											...
											<?php  }else{  ?>
												...
												<div class="col-sm-8">
													<div class="commonSection">
														<label>Title</label>
														<input class="form-control" type="text" required name="title1" id="title" value="<?php echo $b['title']; ?>" placeholder="Enter Heading">
													</div>
												</div>
												...
												<div class="col-sm-12">
													<div class="commonSection">
														<label>Content</label>
														<textarea name="editor12" id="editor12"  rows="10" cols="80" required><?php echo $b['content']; ?></textarea>
														<script>
															CKEDITOR.editorConfig = function (config) {
																config.language = 'es';
																config.uiColor = '#F7B42C';
												...
												<div class="col-sm-12">
													<div class="commonSection">
														<label>Youtube Link</label>
														<input class="form-control" type="text"  name="y_url1" id="y_url" value="<?php echo $b['y_url']; ?>" placeholder="Enter Heading">
													</div>
												</div>
												...
												<div class="col-sm-12">
													<div class="commonSection">
														<label>Dimensions</label>
														<textarea name="editor22" id="editor22"  rows="10" cols="80" ><?php echo $b['dimension']; ?></textarea>
														<script>
															CKEDITOR.editorConfig = function (config) {
																config.language = 'es';
																config.uiColor = '#F7B42C';
