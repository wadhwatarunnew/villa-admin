										...
										<div class="row">
											<div class="col-sm-12">
												<div class="commonSection">
													...
													<input class="form-control" type="text" name="title" required id="title" placeholder="Enter Title" required>
												</div>
											</div>
											...
											<div class="col-sm-12">
												<div class="commonSection">
													...
													<input class="form-control" type="text" name="url" required id="url" placeholder="Enter URL" required>
												</div>
											</div>
