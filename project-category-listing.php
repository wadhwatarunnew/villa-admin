<?php 
   ...
   $PageTitle = "Villatent: Projects Category";

   if(isset($_GET["id"]) && $_GET["id"] != '')
   {
      $id = $_GET["id"];
      mysqli_query($con, "DELETE FROM project_category WHERE id='$id'");
      $_SESSION['BannerColor'] = "background-color:#FF0000;";
      $_SESSION['Message'] = "Deleted successfully!";
      echo "<script>window.location.href='project-category-listing.php';</script>";
      exit;
   }
?>
            ...
            <div class="page-body">
               <div class="listing-page-head">
                  <div class="listing-title-wrap">
                     <h1>Project Category Listing</h1>
                     <div class="listing-breadcrumb">
                        <span>Dashboard</span><span class="crumb-sep">&gt;</span><span>Project Category Listing</span>
                     </div>
                  </div>

                  <div class="listing-cta">
                     <a href="add-project-category.php" class="btn btn-success btn-sm"><i class="feather icon-plus"></i> Add Category</a>
                  </div>
               </div>
                                    ...
                                    <td>
                                       <div class="actions">
                                          <div class="table-actions">
                                             ...
                                             <a href="project-category-listing.php?id=<?php echo $b['id']; ?>" onclick="return confirm('Are you sure you want to delete this category?')">
