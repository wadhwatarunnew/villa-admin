<?php
   ...
   $PageTitle = "Villatent: Resorts Category";

   if(isset($_GET["id"]) && $_GET["id"] != '')
   {
      $id = $_GET["id"];
      mysqli_query($con, "DELETE FROM resort_category WHERE id='$id'");
      $_SESSION['BannerColor'] = "background-color:#FF0000;";
      $_SESSION['Message'] = "Deleted successfully!";
      echo "<script>window.location.href='resort-category-listing.php';</script>";
      exit;
   }
?>
                     ...
                     <div class="table-responsive">
                        <table class="table table-bordered listing-table">
                           ...
                           <tbody>
                              <?php
                                 $i = 1;	 
                                 $query4= mysqli_query($con,"SELECT * FROM resort_category");
                                    ...
                                    <td>
                                       <div class="actions">
                                          <div class="table-actions">
                                             ...
                                             <a href="resort-category-listing.php?id=<?php echo $b['id']; ?>" onclick="return confirm('Are you sure you want to delete this category?')">
