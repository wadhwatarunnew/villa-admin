...
if (isset($_POST['update_seo'])){
	...
	//header("location:edit-single-blog.php");
...
if (isset($_POST['update'])){
	...
	if(!$imageUrl){
    	...
    	else
    	{
        	...
        	//header("location:edit-single-blog.php?id=$id");
        	header( "refresh:2; url=edit-single-blog.php?id=$id" );
    	}
                              ...
                              <div class="card-body">
								 ...
								 <?php 
                                    ...
                                    <div class="col-sm-4">
                                       <div class="commonSection">
                                          <label>Date</label>
                                          <input class="form-control" type="date" name="date1" required id="date1" value="<?php echo $b['date']; ?>" placeholder="Enter Heading">
                                       </div>
                                    </div>
