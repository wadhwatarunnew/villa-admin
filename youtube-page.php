...
<?php $PageTitle = "Villatent: Youtube Page"; ?>
				...
				<div class="page-body">
					<div class="listing-page-head">
						...
						<div class="listing-cta">
							...
							<?php if(!$e['local_path']){ ?>
							<input type="submit" class="btn btn-success btn-sm" id="btnn" name="update" value="Save" form="youtubeContentForm">
							<?php }else{ ?>
							<input type="submit" class="btn btn-success btn-sm" id="btnn1" name="update1" value="Save" form="youtubeContentForm">
							<?php } ?>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-12">
							<form action="" enctype="multipart/form-data" method="post" id="youtubeContentForm">
								<div class="row">
									...
									<div class="col-lg-6 col-md-12">
										<div class="card mb-30">
											<div class="card-header">Youtube Content</div>
											<div class="card-body">
