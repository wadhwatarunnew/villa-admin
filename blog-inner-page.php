                        ...
                        <div class="listing-page-head">
                           ...
                           <div class="listing-cta">
                              <a href="blog-list-page.php" class="btn btn-primary btn-sm"><i class="feather icon-arrow-left"></i> Back to Blogs</a>
										<button type="submit" class="btn btn-success btn-sm" name="sub"><i class="feather icon-save"></i> Save Blog</button>
                           </div>
                        </div>
                     </div>
                  </div>
	                              ...
	                              <div class="col-sm-12">
	                                 <div class="commonSection">
	                                    ...
	                                    <div class="radio-inline-group" style="display: inline !important;">
													   <label for="id_radio1"><input id="id_radio1" type="radio" name="img" onclick="show1();" <?php echo ($b['image'] != '') ? 'checked' : ''; ?> checked="">Image URL</label>
