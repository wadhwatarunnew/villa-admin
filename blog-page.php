...
$FileExists = false;
$query2= mysqli_query($con,"select * from blog_seo_meta_data");
										
$d=mysqli_fetch_assoc($query2);	

$query3= mysqli_query($con,"select * from blog_content");
...
if (isset($_POST['update_seo'])){
	...
	mysqli_query($con,"UPDATE blog_seo_meta_data SET title='$metaTitle',keyword='$keyword',discription='$disc' ");
	
	//header("location:blog-page.php");
	header( "refresh:2; url=blog-page.php" ); 
};
...
if (isset($_POST['update'])){
	...
	if(!$imageUrl){
    	...
    	else
    	{
        	...
        	mysqli_query($con,"update blog_content SET title='$title',content='$editor1',image='',local_path='$path'");
	...
	mysqli_query($con,"update blog_content SET title='$title',content='$editor1',image='$imageUrl' ");
	//header("location:edit-home-slider.php");
		header( "refresh:2; url=blog-page.php" );
	...
	if(!$imageUrl1){
    	...
    	else
    	{
        	...
        	if(!$_FILES['myFile1']['name']){
        		...
        		mysqli_query($con,"update blog_content SET title='$title1',content='$editor2' ");
        		
        		//header("location:blog-page.php");
        		header( "refresh:2; url=blog-page.php" );
        	}else{
        		
        		mysqli_query($con,"update blog_content SET title='$title1',content='$editor2',local_path='$path1' ");
    	...
    	mysqli_query($con,"update blog_content SET title='$title1',content='$editor2',image='$imageUrl1',local_path='' ");
				...
				<div class="page-body">
					<div class="listing-page-head">
						<div class="listing-title-wrap">
							...
							<div class="listing-breadcrumb">
								<span>Dashboard</span><span class="crumb-sep">&gt;</span><span>Blogs</span><span class="crumb-sep">&gt;</span><span>Edit Content</span>
							</div>
						</div>
						<div class="listing-cta">
							...
							<?php }else{ ?>
							<input type="submit" class="btn btn-success btn-sm" id="btnn1" name="update1" value="Save" form="blogContentForm">
							<?php } ?>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-12">
							<form action="" enctype="multipart/form-data" method="post" id="blogContentForm">
								<div class="row">
